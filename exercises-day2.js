...
//4. Create a function named `sumOfArray` that loops through an array, and returns the 
//sum of all the numbers that are less than or equal to 5
var sum = 0;
...
var area = rect.width*rect.width;
console.log(area);
...
var circle = { 
    cx: 34,
    cy:  43,
    redius: numbers[numbers.length-1]
}
console.log(circle);
...
var hypotenuse = Math.sqrt(Math.pow(shapes.rightTriangle.base, 2) + Math.pow(shapes.rightTriangle.height, 2));
console.log(hypotenuse);

shapes.rightTriangle.hypotenuse = hypotenuse;
